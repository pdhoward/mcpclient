...
const ActivateButton: React.FC = () => {
  ...
  return (
    <div className="relative isolate">
      <button
        className="relative flex items-center gap-1 px-5 py-3 text-2xl font-medium text-transparent rounded-full cursor-pointer bg-[hsl(260,97%,12%)] hover:bg-[radial-gradient(40%_50%_at_center_100%,hsl(270,97%,72%),transparent),radial-gradient(80%_100%_at_center_120%,hsl(260,97%,70%),transparent),hsl(260,97%,56%)] focus-visible:bg-[radial-gradient(40%_50%_at_center_100%,hsl(270,97%,72%),transparent),radial-gradient(80%_100%_at_center_120%,hsl(260,97%,70%),transparent),hsl(260,97%,56%)] shadow-[0_0_0_0_hsl(260,97%,61%/0),0_0.05em_0_0_hsl(260,97%,62%)_inset,0_-0.05em_0_0_hsl(260,97%,72%)_inset] hover:shadow-[0_0_6em_3em_hsl(260,97%,61%/0.75),0_0.05em_0_0_hsl(260,97%,62%)_inset,0_-0.05em_0_0_hsl(260,97%,72%)_inset] focus-visible:shadow-[0_0_6em_3em_hsl(260,97%,61%/0.75),0_0.05em_0_0_hsl(260,97%,62%)_inset,0_-0.05em_0_0_hsl(260,97%,72%)_inset] scale-100 hover:scale-110 focus-visible:scale-110 active:scale-100 transition-all duration-250 before:content-[''] before:absolute before:inset-[-0.25em] before:z-[-1] before:border-4 before:border-[hsl(260,97%,50%/0.5)] before:rounded-full before:opacity-0 hover:before:opacity-100 focus-visible:before:opacity-100 before:transition-opacity before:duration-250"
      >
        ...
        <span className="backdrop absolute inset-[0.1em] rounded-full bg-[hsl(260,97%,12%)] hover:bg-[radial-gradient(40%_50%_at_center_100%,hsl(270,97%,72%),transparent),radial-gradient(80%_100%_at_center_120%,hsl(260,97%,70%),transparent),hsl(260,97%,56%)] focus-visible:bg-[radial-gradient(40%_50%_at_center_100%,hsl(270,97%,72%),transparent),radial-gradient(80%_100%_at_center_120%,hsl(260,97%,70%),transparent),hsl(260,97%,56%)] transition-colors duration-250" />
        <svg
        ...
        <span className="text translate-x-[2%] -translate-y-[6%] bg-gradient-to-r from-[hsl(0,0%,65%)] to-[hsl(0,0%,26%)] hover:bg-gradient-to-r hover:from-[hsl(0,0%,100%)] hover:to-[hsl(0,0%,100%)] focus-visible:bg-gradient-to-r focus-visible:from-[hsl(0,0%,100%)] focus-visible:to-[hsl(0,0%,100%)] bg-clip-text transition-colors duration-250">
          Voice Agent Gallery
        </span>
      </button>
      <div className="bodydrop fixed inset-0 bg-[hsl(260,0%,6%)] hover:bg-[hsl(260,97%,6%)] focus-visible:bg-[hsl(260,97%,6%)] z-[-1] transition-colors duration-250" />
      <span
        ref={particlePenRef}
        aria-hidden="true"
        ...
        {Array.from({ length: 10 }).map((_, i) => (
          ...
          >
            <path
              ...
              fill="hsl(260,97%,70%)" // Changed to match purple sparkle
              stroke="none"
            />
          </svg>
        ))}
